...
<table width="99%" border="0" cellpadding="3" cellspacing="1" bgcolor="#D6D6D6">
 ...
 <?php if(is_array($re)): $i = 0; $__LIST__ = $re;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr bgcolor="#FFFFFF" align="center">
    <td height="24" width="5%">
	<input type="checkbox" name="tables" value="<?php echo ($vo["Tables_in_new"]); ?>" class="np" /> 
	</td>
    <td width="20%"><?php echo ($vo["tables"]); ?></td>
    <td width="8%">记录数</td>
    <td>
    <a href="#" onClick="LoadUrl('optimize&<?php echo ($vo["Tables_in_new"]); ?>');">优化</a> |
    <a href="#" onClick="LoadUrl('repair&<?php echo ($vo["Tables_in_new"]); ?>');">修复</a> |
    <a href="#" onClick="LoadUrl('viewinfo&<?php echo ($vo["Tables_in_new"]); ?>');">结构</a>
  </td>
