  ...
  <tr>
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="../Config/index" target="mainFrame">基本配置</a></li>
          
        </ul>
      </div>
	   <h1 class="type"><a href="javascript:void(0)">学生专区学员管理</a></h1>
      <div class="content">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><img src="__PUBLIC__/images/menu_topline.gif" width="182" height="5" /></td>
        ...
        <ul class="MM">
          <li><a href="./xxll" target="mainFrame">信息列表</a></li>
          <li><a href="./xxtj" target="mainFrame">信息添加</a></li>
        </ul>
      </div>
      <h1 class="type"><a href="javascript:void(0)">学员问题查看</a></h1>
      <div class="content">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><img src="__PUBLIC__/images/menu_topline.gif" width="182" height="5" /></td>
        ...
        <ul class="MM">
          <li><a href="./show" target="mainFrame">查看在线报名</a></li>
		  <li><a href="./tijiao" target="mainFrame">查看问题提交</a></li>
        </ul>
      </div>
      ...
      <div class="content">
        ...
        <ul class="MM">
          <li><a href="./lbgl" target="mainFrame">类别管理</a></li>
        </ul>
      </div>
   
	 <h1 class="type"><a href="javascript:void(0)">管理员列表</a></h1>
      <div class="content">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><img src="__PUBLIC__/images/menu_topline.gif" width="182" height="5" /></td>
        ...
        <ul class="MM">
		  <li><a href="./modmima" target="mainFrame">管理员修改密码</a></li>
		   <li><a href="./listmima" target="mainFrame">管理员列表</a></li>
        </ul>
      </div>
	 <h1 class="type"><a href="javascript:void(0)">广告管理</a></h1>
      <div class="content">
        ...
        <ul class="MM">
		  <li><a href="./mainfra" target="mainFrame">广告列表</a></li>
        </ul>
      </div>
      ...
      <div class="content">
        ...
        <ul class="MM">
            <li><a href="./mainfra" target="mainFrame">评论列表</a></li>
        </ul>
      </div>
