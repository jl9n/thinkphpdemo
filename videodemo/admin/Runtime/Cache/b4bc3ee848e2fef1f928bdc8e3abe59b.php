...
<script type="text/javascript" charset="utf-8" src="__PUBLIC__/ueditor/ueditor.all.js"></script>
  ...
  <div class="wrapper">
  			...
  			<nav>
  				<div class="nav-list">
  					<ul class="nav-mian">
	  					...
	  					<li class="on-nav"><a href="__URL__/left" target="left">信息管理</a></li>
	  					<li><a href="__URL__/left" target="left">招生信息管理</a></li>
	  					<li><a href="#">教务考务</a></li>
		...
		<div align='right'>欢迎  <?php echo ($name); ?>光临|<span id="clime"><?php if(($msg > 0)): ?><span style="color:red;">新消息(<?php echo ($msg); ?>)</span><?php else: ?>消息<?php endif; ?></span>|<a href="__APP__/Login/loginout">退出</a></div
