...
<html>
 ...
 <!--
	function add(){
		window.location.href="/Think321demo/Curd/Index/add";
	}
	function edit(id){
		window.location.href="/Think321demo/Curd/Index/edit/id/"+id;
	}
	function del(id){
		window.location.href="/Think321demo/Curd/Index/delete/id/"+id;
	}
 //-->
 </script>
 <div class="main">
