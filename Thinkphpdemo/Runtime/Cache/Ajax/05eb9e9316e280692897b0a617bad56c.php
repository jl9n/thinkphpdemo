...
<html>
    ...
    <script type="text/javascript" src="/Think321demo/Public/Ajax/js/Jquery/jquery.min.js"></script>
    <script type="text/javascript" src="/Think321demo/Public/Ajax/js/Jquery/jquery.form.js"></script>
	<style type="text/css">
...
<body><script language="JavaScript">
    ...
    function checkTitle(){
        $.post('/Think321demo/Ajax/Index/checkTitle',{'title':$('#title').val()},function(data){
            $('#result').html(data.info).show();
        },'json');
    } 
    //-->
    ...
    <div class="main">
        ...
        <form id="form1" method='post' action="/Think321demo/Ajax/Index/insert">   
