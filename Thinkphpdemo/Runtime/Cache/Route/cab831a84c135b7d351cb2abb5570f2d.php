    ...
    <body>
        <div class="main">
            ...
            <table  cellpadding=3 cellspacing=3>
                ...
                <tr>
                    <td class="tLeft" >
                        路由1：<a href="<?php echo U('/Think321demo/Route/blog/curd');?>">blog/curd</a><br/>
                        路由2：<a href="<?php echo U('/Think321demo/Route/blog/5');?>">blog/5</a><br/>
                        路由3：<a href="<?php echo U('/Think321demo/Route/blog/2012/09');?>">blog/2012/09</a><br/>
                        路由4：<a href="<?php echo U('/Think321demo/Route/100');?>">100</a><br/>
                    </td>
                </tr>
            </table>
        </div>
