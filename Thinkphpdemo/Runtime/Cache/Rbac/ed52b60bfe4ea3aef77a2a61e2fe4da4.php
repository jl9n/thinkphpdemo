...
<!-- 主体内容  -->
<div class="content" >
<div class="title"> 应用授权 [ <a href="/Think321demo/Rbac/Role">返回</a> ]</div>
<!--  功能组区域  -->
<script language="JavaScript">
<!--
function saveAccess(){
ThinkAjax.sendForm('form1','/Think321demo/Rbac/Role/setApp/');
}
//-->
</script>
...
<tr><th class="tCenter">应用授权 | <a href="/Think321demo/Rbac/Role/module/groupId/<?php echo ($_GET['groupId']); ?>">模块授权</a> | <a href="/Think321demo/Rbac/Role/action/groupId/<?php echo ($_GET['groupId']); ?>">操作授权</a>
</th></tr>
