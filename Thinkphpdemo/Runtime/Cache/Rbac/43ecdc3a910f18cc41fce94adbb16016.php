...
<div class="content">
<div class="title">编辑分组 [ <a href="/Think321demo/Rbac/Group">返回列表</a> ]</div>
...
<tr>
	...
	<div class="impBtn fLeft"><input type="button" value="保存" onclick="sendForm('form1','/Think321demo/Rbac/Group/update/','tips')" class="save imgButton"></div>
