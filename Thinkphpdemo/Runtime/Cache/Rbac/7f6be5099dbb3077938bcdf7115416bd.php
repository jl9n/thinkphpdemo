...
<div class="content">
<div class="title">编辑<?php if(($vo["level"]) == "1"): ?>应用<?php endif; if(($vo["level"]) == "2"): ?>模块<?php endif; if(($vo["level"]) == "3"): ?>操作<?php endif; ?> [ <a href="/Think321demo/Rbac/Node">返回列表</a> ]</div>
<form method='post'  id="form1" action="/Think321demo/Rbac/Node/update/">
