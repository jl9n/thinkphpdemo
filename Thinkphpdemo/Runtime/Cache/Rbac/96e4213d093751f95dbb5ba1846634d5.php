...
<!-- 主体内容  -->
<div class="content" >
<div class="title"> 操作授权 [ <a href="/Think321demo/Rbac/Role">返 回</a> ] </div>
<!--  功能组区域  -->
<script language="JavaScript">
<!--
function saveAccess(){
ThinkAjax.sendForm('form1','/Think321demo/Rbac/Role/setAction/');
}
//-->
</script>
<div id="result" class="result none"></div>
<script type="text/javascript" src="/Think321demo/Public/Js/Form/MultiSelect.js"></script>
<form method=post id="form1">
<table class="select" style="width:265px" align="center">
<tr><td height="3" colspan="3" class="topTd" ></td></tr>
<tr><th class="tCenter"><a href="/Think321demo/Rbac/Role/app/groupId/<?php echo ($_GET['groupId']); ?>">应用授权</a> | <a href="/Think321demo/Rbac/Role/module/groupId/<?php echo ($_GET['groupId']); ?>">模块授权</a> | 操作授权
</th></tr>
