...
function resetPwd(){
var pass	 =	 $F('resetPwd');
ThinkAjax.send('/Think321demo/Rbac/User/resetPwd/','ajax=1&id=<?php echo ($vo["id"]); ?>&password='+encodeURIComponent(pass));
}
//-->
</script>
<div class="content">
<div class="title">编辑帐号 [ <a href="/Think321demo/Rbac/User">返回列表</a> ]</div>
...
<tr>
	...
	<input type="button" value="保 存" onclick="sendForm('form1','/Think321demo/Rbac/User/update/')" class="small submit">
