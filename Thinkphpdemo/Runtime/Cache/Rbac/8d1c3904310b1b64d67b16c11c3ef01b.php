...
<!-- 主体内容  -->
<div class="content" >
<div class="title">组用户列表 [ <a href="/Think321demo/Rbac/Role">返 回</a> ]</div>
<!--  功能组区域  -->
<script language="JavaScript">
<!--
function saveAccess(){
ThinkAjax.sendForm('form1','/Think321demo/Rbac/Role/setUser/');
}
